...
_0x6:
	...
	.DB  LOW(_0x5+16),HIGH(_0x5+16),LOW(_0x5+20),HIGH(_0x5+20),LOW(_0x5+24),HIGH(_0x5+24),LOW(_0x5+28),HIGH(_0x5+28)
_0x0:
	.DB  0x45,0x72,0x72,0x0,0x53,0x75,0x6E,0x0
	.DB  0x4D,0x6F,0x6E,0x0,0x54,0x75,0x65,0x0
	.DB  0x57,0x65,0x64,0x0,0x54,0x68,0x75,0x0
	.DB  0x46,0x72,0x69,0x0,0x53,0x61,0x74,0x0
	.DB  0x25,0x30,0x32,0x75,0x3A,0x25,0x30,0x32
	.DB  0x75,0x3A,0x25,0x30,0x32,0x75,0x0,0x54
	.DB  0x69,0x6D,0x65,0x3A,0x0,0x25,0x30,0x32
	.DB  0x75,0x2F,0x25,0x30,0x32,0x75,0x2F,0x32
	.DB  0x30,0x25,0x30,0x32,0x75,0x20,0x25,0x73
	.DB  0x0
_0x2000003:
	.DB  0x80,0xC0
...
; 0000 0040         rtc_get_date(&weekday, &day, &month, &year);
	LDI  R30,LOW(_weekday)
	LDI  R31,HIGH(_weekday)
	ST   -Y,R31
	ST   -Y,R30
	LDI  R30,LOW(10)
	LDI  R31,HIGH(10)
