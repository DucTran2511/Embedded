...
glcd_init_data.temp_coef=1590; // range of value from 120 ---> 160
// Set the LCD bias
glcd_init_data.bias=4; // range of value from 2 ---> 4
// Set the LCD contrast control voltage VLCD
glcd_init_data.vlcd=55; // range of value from 35 --> 55

glcd_init(&glcd_init_data);


glcd_outtextxy(5, 5, "em duc dep trai");
glcd_rectangle(5, 5, 25, 25);
glcd_circle(25, 25, 10);
glcd_circle(42, 24, 20);
glcd_rectangle(3, 3, 78, 42);
while (1)
      {
