...
_0x5:
	...
	RJMP _0x6
; 0000 0016     {
; 0000 0017         if (j == 0) PORTF = 0b11111101;
	MOV  R0,R20
	OR   R0,R21
	BRNE _0x7
	LDI  R30,LOW(253)
	STS  98,R30
; 0000 0018         if (j == 1) PORTF = 0b11110111;
_0x7:
	LDI  R30,LOW(1)
	LDI  R31,HIGH(1)
	CP   R30,R20
	...
	LDI  R30,LOW(247)
	STS  98,R30
; 0000 0019         if (j == 2) PORTF = 0b11011111;
_0x8:
	LDI  R30,LOW(2)
	LDI  R31,HIGH(2)
	CP   R30,R20
...
; 0000 001E                     lcd_gotoxy(0, 0);
	CALL SUBOPT_0x0
; 0000 001F                     sprintf(data, "%u", keypad[i][j]);
; 0000 0020                     lcd_puts(data);
...
; 0000 0027                     lcd_gotoxy(0,0);
	CALL SUBOPT_0x0
; 0000 0028                     sprintf(data, "%u", keypad[i][j]);
; 0000 0029                     lcd_puts(data);
...
; 0000 0030                     lcd_gotoxy(0, 0);
	CALL SUBOPT_0x0
; 0000 0031                     sprintf(data, "%u", keypad[i][j]);
; 0000 0032                     lcd_puts(data);
